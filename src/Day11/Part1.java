...
public class Part1 {
	...
	public static void main(String[] args) {	
		...
		list.add(new Monkey(5, 3, 7, 4, (a, b) -> a * b, queue, delit, true));
		
		// 1 monkey
		queue = new LinkedList<>();
		queue.add(new Item(70));
		list.add(new Monkey(6, 17, 3, 0, (a, b) -> a + b, queue, delit, true));
		...
		list.add(new Monkey(5, 2, 3, 1, (a, b) -> a + b, queue, delit, true));
		...
		list.add(new Monkey(2, 19, 7, 0, (a, b) -> a + b, queue, delit, true));
		...
		list.add(new Monkey(7, 11, 5, 6, (a, b) -> a * b, queue, delit, true));
		...
		list.add(new Monkey(7, 5, 2, 1, (a, b) -> a + b, queue, delit, true));
		...
		queue.add(new Item(71));
		list.add(new Monkey(1, 13, 5, 2, (a, b) -> a + b, queue, delit, true));
		
		// 7 monkey
		queue = new LinkedList<>();
		queue.add(new Item(76));
		queue.add(new Item(50));
		list.add(new Monkey(1, 7, 4, 6, (a, b) -> a * a, queue, delit, true));
